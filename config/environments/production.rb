...
Rails.application.configure do
  ...
  # Ensures that a main key has been made available in either
  # ENV["RAILS_MAIN_KEY"]
  # or in config/main.key. This key is used to decrypt credentials
  # (and other encrypted files).
  # config.require_main_key = true
  ...
  # config.active_job.queue_name_prefix = "favorite_places_production"
  ...
  host = 'https://favorite-places-dsk.herokuapp.com/'
